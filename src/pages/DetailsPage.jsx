    ...
    <main id="main-content" className="details-page">
      ...
      <section className="application-details">
        ...
        <div className="image-apply-container">
          ...
          />
          <button
            className="btn-apply-program-full"
        ...
        <div className="program-desc-container">
          ...
          <div className="exhibition-info">
            <img
              ...
              alt="수원시립만석전시관 로고"
              className="exhibition-logo-image"
            />
        ...
        <div className="recruitment-section">
          ...
          <div className="recruitment-header">
            ...
            <h3 className="recruitment-title">
              &lt;그린그린 뮤지엄: 별가루 신비정원&gt;(3.24. ~ 7.24.) 유아 단체
              도슨트 프로그램 4월 모집
            </h3>
            <ul className="recruitment-list">
              <li>1개월 단위로 예약창이 오픈됩니다.</li>
              <li>
                6월 모집 예약창 : 5월 12일 (화) 오전 10시에 오픈 (※선착순 접수)
              </li>
          ...
          <div className="recruitment-part">
            ...
            <ul className="part-list">
              <li>
                유치원 · 어린이집· 초등학교와 연계하여 유아 및 아동의 눈높이에
                맞춘 전시 해설 프로그램입니다.
              </li>
              <li className="notice-text">
                ※ 단체가 아닌 일반 관람객분들을 위한 상시 해설은 16시(화~토
                ※일요일 미운영)에 진행되며 별도 예약은 없습니다.
              </li>
              <li>
                어린이 전문 도슨트의 단체 대상 전시 해설이 진행되며, 이후
                자유롭게 작품 감상 및 상시 교육 활동 참여가 가능합니다.
              </li>
            </ul>
          </div>
          ...
          <div className="recruitment-part">
            ...
            <ul className="part-list">
              <li>요일 : 화~금 (월요일 휴관)</li>
              <li>
                시간 : 10:30 ~ 11:30 (도슨트 해설 20분 + 상시 교육활동 30분)
              </li>
              <li>대상 : 5세 이상 (0~4세 참여 불가)</li>
              <li className="notice-text">
                ※ 즐거운 전시 해설 참여(전시 및 작품 이해, 도슨트와의 소통 등)를
                위한 연령입니다.
              </li>
              <li className="notice-text">
                ※ 어린이 대상 기관이 아닌 단체는 예약이 취소 될 수 있습니다.
              </li>
              <li>
                참여인원 : 하루 최대 20인(단체 대상 프로그램으로 최소 10명 이상
                신청하셔야 예약이 확정됩니다.)
              </li>
              <li className="notice-text">
                ※ 안전한 전시 관람을 위해 참여 인원을 제한합니다.
              </li>
              <li className="notice-text">
                ※ 20명 이상의 인원 수용을 원하시는 경우 2일 이상으로 예약
                진행(예: 40명 예약 - 4월 15일:20명 / 4월 16일: 20명)
              </li>
            </ul>
          </div>
          ...
          <div className="recruitment-part">
            ...
            <div className="part-content">
              ...
              <p className="notice-text">
                ※ 예약 확인 및 확정 절차를 위해 담당 매니저 유선 연락이
                진행됩니다.
              </p>
              <ul className="part-list mt-8 no-dot">
                <li>
                  1) 유선 협의 후 기타 이유(연령대, 인원 등)로 예약이 취소 될 수
                  있습니다. (031-5191-4114)
                </li>
                <li>
                  2) 접수는 선착순으로 이루어지며 예약 확정 후 문자 발송
                  예정입니다.
                </li>
                <li>3) 관람객 안전을 위하여 인솔 교사 동행은 필수 입니다.</li>
                <li>
                  4) 전시장 내 음료 및 기타 음식물 취식은 엄격히 금지됩니다.
                </li>
                <li>
                  5) 취소 시, 반드시 유선으로 연락 부탁드립니다.(031-5191-4114)
                </li>
              </ul>
            </div>
          </div>
