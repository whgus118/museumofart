  ...
  return (
    <section className="section-3" aria-labelledby="section3-title">
      <div className="section-3-header">
        <h2 id="section3-title" className="section-3-title">
          찾아오시는 길
        </h2>
        <a
          href="/location"
            ...
            <>
              <ul className="timeline-list">
                <li className="timeline-item">
                  ...
                  <div className="timeline-content no-padding">
                    <strong>
                      수원역
                      <span className="line-badge badge-1">1호선</span>
                      <span className="line-badge badge-suin">수인·분당선</span>
                    </strong>
                    <span>7번 출구 진출 후 56m 이동</span>
                  </div>
                </li>
                <li className="timeline-item is-ride">
                  <div className="timeline-visual">
                  ...
                  <div className="timeline-content">
                    <strong>수원역, AK플라자 정류장 승차</strong>
                    <span>66, 66-4, 82-1, 60, 7-2, 660</span>
                  </div>
                </li>
                <li className="timeline-item">
                  <div className="timeline-visual">
              ...
              <ul className="timeline-list" style={{ marginTop: '40px' }}>
                <li className="timeline-item">
                  <div className="timeline-visual">
                    <span className="timeline-dot" aria-hidden="true"></span>
                  </div>
                ...
                <li className="timeline-item">
                  ...
                  <div className="timeline-content">
                    <strong>팔달구청, 화성행궁 정류장 하차</strong>
                    <span>도보 3분 이동</span>
                  </div>
                </li>
                <li className="timeline-item">
            ...
            <div className="parking-panel">
              ...
              <div className="parking-info-list">
                <div className="parking-info-row">
                  ...
                  <div className="parking-info-text">
                    ...
                    <span className="parking-sub-text">
                      ※ 주차공간이 협소하여 주말에는 대중교통을 이용하시는 것이
                      편리합니다. (주차면수: 77대)
                    </span>
                  </div>
                </div>
              ...
              <div className="parking-discount-info">
                <p className="discount-notice">
                  ※ 감면대상 차량: 정산기에서 정산 전 호출버튼을 누르고 감면차량
                  여부(증빙자료 제시) 확인 후 할인적용이 가능합니다.
                </p>
                ...
                <ul className="discount-list">
                  ...
                  <li>
                    ...
                    <span>
                      장애인(경), 다자녀(2자녀 이상, 최연소 자녀가 18세 이하),
                      병역명문가, 경차, 저공해차
                    </span>
                  </li>
                  <li>
